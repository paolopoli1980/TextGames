...
while wordkey!='exit':
    ...
    if wordkey=='achievements':
            if achievements(xgalaxycenterdist, ygalaxycenterdist, zgalaxycenterdist,h0,maxdiam,mindiam)==True:
                print('You won!')
                exit
            else:
...
if request=='y':
    ...
    with open(filename,"w") as f:
        ...
        f.write(no+str('\n'))
        f.write(x,y,z+str('\n'))
        f.write(xgalaxycenterdist, ygalaxycenterdist, zgalaxycenterdist+str('\n'))
